...
def upgrade():
    ...
    op.bulk_insert(user,
        [
            ...
            },
            {
                ...
                'last_name': 'User',
                'primary_email': 'unassigned@user.com',
                'credentials_id': model.Credentials.unassigned_credentials_id
            }
        ]
    )
    ...
    mtn_time_zone_id = str(uuid.uuid4())
    op.bulk_insert(time_zone,
        [
            {'time_zone_id': mtn_time_zone_id, 'time_zone_name': 'Mountain Time', 'time_zone_code': 'US/Mountain'},
    ...
    op.execute(
        email_config.insert().values(
            ...
            from_address='unassigned321@gmail.com',
