...
def update_janium_campaign_step():
    """
    Required JSON keys: janium_campaign_step_id, janium_campaign_id, janium_campaign_step_delay, janium_campaign_step_body,
    ...
    janium_campaign_step = db.session.query(Janium_campaign_step).filter(Janium_campaign_step.janium_campaign_step_id == json_body['janium_campaign_step_id']).first()
    ...
    # janium_campaign_step.queue_start_time = janium_campaign.queue_start_time
    # janium_campaign_step.queue_end_time = janium_campaign.queue_end_time
