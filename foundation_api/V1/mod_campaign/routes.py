...
from foundation_api.V1.mod_campaign.models import User, Account, Ulinc_config, Credentials, Cookie, Contact, Action, Janium_campaign, Ulinc_campaign
...
@mod_campaign.route('/update_janium_campaign', methods=['PUT'])
@jwt_required()
